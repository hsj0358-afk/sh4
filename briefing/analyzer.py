...
CATEGORY_ORDER = ["KT", "COMPETITOR", "AI", "HRD", "HRM", "ESG", "CULTURE", "LABOR"]
CATEGORY_TITLES = {
    "KT": "KT 관련 (꼭 알아야 할)",
    "COMPETITOR": "경쟁사·타사 동향 (SKT·LG U+ 등)",
    "AI": "AI·AX 트렌드",
    "HRD": "HRD (상세)",
    "HRM": "HRM",
    "ESG": "ESG",
...
# --------------------------------------------------------------------------
SELECT_SYSTEM = """\
너는 KT의 HRD(인재개발) 부서 분석 담당자다. 회사(KT)의 비전은 'AX Platform Company'다.
부서장은 매일 아침 6개 종이신문(조선·중앙·동아·매일경제·한국경제·전자신문)을 읽는다.
아래에 오늘 지면 기사 '제목' 목록이 주어진다. 부서장에게 보고할 가치가 있는 번호만 골라라.

선별 기준(하나라도 해당하면 선택):
1. KT 및 그 계열사/경영진 관련 (KT, KT클라우드, BC카드, 케이뱅크, 스카이라이프, 박윤영 대표 등)
2. 직접 경쟁사 SK텔레콤(SKT)·LG유플러스 동향 — HR뿐 아니라 AI/AX·사업 전략까지 폭넓게
3. AI/AX 트렌드 (생성형 AI·LLM·AI 에이전트·AX 전환·AI 인프라/데이터센터 등) — KT 비전과 직결
4. HRD(인재개발/교육/리스킬링/리더십), HRM(채용·인사·평가보상·임금·정년 등)
5. ESG(지속가능경영·지배구조·사회공헌·탄소중립), 기업문화/조직문화, 노사관계/노사상생
6. 위 4~5번 관점에서 의미 있는 '타사(주요 대기업) 동향' (단순 실적·주가·제품 기사는 제외)

주의: 'KT&G'(담배)와 'KTX'(철도)는 KT그룹과 무관하니 KT로 보지 마라.
...
BRIEF_SYSTEM = """\
너는 KT의 HRD(인재개발) 부서 분석 담당자다. 회사(KT)의 비전은 'AX Platform Company'다.
부서장은 매일 아침 6개 종이신문(조선·중앙·동아·매일경제·한국경제·전자신문)을 읽으며,
부서원이 그 내용 중 '알아야 할 것'과 '회의/대화에서 언급할 만한 것'을 브리핑으로 받기를 원한다.

아래 기사들(제목+본문)을 분석해 카테고리별 브리핑을 만들어라.

[카테고리 키]
- "KT": KT 및 계열사/경영진(박윤영 대표 등) 관련 — 부서장이 반드시 알아야 할 것
- "COMPETITOR": 직접 경쟁사 SK텔레콤(SKT)·LG유플러스 동향(HR·AI/AX·사업 전략 등 폭넓게)
  + 그 외 주요 대기업의 인사/조직/노사/ESG/문화 움직임
- "AI": AI/AX 트렌드 — 생성형 AI·LLM·AI 에이전트·AX 전환·AI 인프라(데이터센터/AI반도체) 등.
  KT 비전과 연결지어, HRD가 알아야 할 시사점 위주로
...
- 'KT&G'(담배)·'KTX'(철도)는 KT그룹과 무관하니 KT 로 분류하지 마라.
